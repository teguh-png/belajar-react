...
export default class FormElement extends React.Component {
    ...
    render () {
        return (
            ...
            <label>
                Nama : <input type="text" name="nama" defaultValue={this.state.nama} onChange={e => this.setState({nama: e.target.value})} />
            </label>
            <br/>
            <label>
            ...
            <br />
            <label>
                Alamat : <textarea cols="30" rows="10" name="alamat" value={this.state.alamat} onChange={e => this.setState({alamat: e.target.value})} />
            </label>
            <br />
            <label>
